 ...
 * Run with: pnpm dlx tsx scripts/create-admin.ts
 */
async function main() {
  ...
  if (!name || !pin) {
    console.error('Usage: pnpm dlx tsx scripts/create-admin.ts <name> <pin>');
    console.error('Example: pnpm dlx tsx scripts/create-admin.ts "Admin User" "1234"');
    process.exit(1);
  }
